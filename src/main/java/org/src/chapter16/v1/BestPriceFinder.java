...
import org.src.chapter16.ExchangeService;
import org.src.chapter16.ExchangeService.Money;
...
public class BestPriceFinder {
    ...
    public List<String> findPricesFuture(String product) {
        ...
        // 하나의 스트림으로 연결을 해버리면, CompletableFuture로 각 상점의 정보를 요청할 때 기존 요청 작업이 완료돼야
        // join이 결과를 반환하면서 다음 상점으로 정보를 요청한다.
        // 따라서 분리를 했다.
                    ...
                    CompletableFuture.supplyAsync(() -> shop.getPrice(product))
                            .thenCombine(
                                    CompletableFuture.supplyAsync(
                                            ...
                                            // 자바 9에 추가된 타임아웃 관리 기능, 이런 경우엔 미리 정의한 환전율로 연산을 이어갈 수 있음.
